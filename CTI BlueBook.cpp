...
bool CCTIApp::checkSerialNumber()
{
    ...
    // open the key
	CString szKey("SOFTWARE\\Thuridion\\");
	szKey += GetAppName() + _T("\\");
...
// Dialog Data
	...
	CStaticHyperLink m_wndThuridionLink;
...
CAboutDlg::CAboutDlg() : CDialog(CAboutDlg::IDD)
{
	...
	m_strShortCopyright = CString(SZ_APP_NAME) + _T(", Copyright © 1999 - 2011, Thuridion.  All rights reserved."); 
...
void CAboutDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_STATIC_THURIDION, m_wndThuridionLink);
...
BOOL CAboutDlg::OnInitDialog() 
{
	...
	m_wndThuridionLink.m_fnSetLink("http://www.thuridion.com");
...
HBRUSH CAboutDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
	...
	if ((pWnd->m_hWnd == m_wndThuridionLink.m_hWnd) || (pWnd->m_hWnd == m_wndCTILink.m_hWnd))
	{
